...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m unifork.eval.model_vqa_loader \
...
python scripts/convert_seed_for_submission.py \
    ...
    --result-upload-file ./playground/data/eval/seed_bench/answers_upload/unifork.jsonl
